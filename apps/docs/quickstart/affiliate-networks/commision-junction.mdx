---
title: "Commision Junction (CJ)"
description: "Learn how to connect your Commision Junction account to AffEasy"
---
...
def update_link_external(request):
  res = d.links.update(external_id="ext_12345", request_body=operations.UpdateLinkRequestBody(
    url='https://google.uk',
  ))
