...
type H5Props = HTMLAttributes<HTMLHeadingElement>;
type H6Props = HTMLAttributes<HTMLHeadingElement>;

const components = {
  h1: ({ className, ...props }: H1Props) => (
    <h1
      className={cn(
